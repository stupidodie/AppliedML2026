...
## Installation instruction - Windows 10/11

**NOTE**: Windows instructions are unlikely to work for older versions of Windows.



### Installing Anaconda on Windows 10/11
---

On the [anaconda website](https://www.anaconda.com/distribution/), download the python 3.12+ version of the anaconda installer for windows. __Make sure to select the right file for your system (32-bit or 64-bit)__
