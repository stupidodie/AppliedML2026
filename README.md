# AppliedML2026 - Code Repository

GitHub repository for code used in the course Applied Machine Learning 2026 at University of Copenhagen.
...
---
### Guide: Running things on your laptop
...
This can be done in many ways, and in the following we only introduce two: **Anaconda or VS code**.
...
* [__Instructions for MacOS__](./docs/install_instruction_linux.md)
...
Alternatively, one may use VS code:
* [__Instructions using VS code (all operating systems)__](./docs/install_instructions_vscode.md)

---
### Optional: Running things on ERDA

* [__The instructions for using ERDA are available here__](./docs/install_instruction_erda.md)


---
### Optional: Running things on Google Colab

In order to have access to GPUs, Google Colab is the immediate option.
...
*	[Course Main page](https://www.nbi.dk/~petersen/Teaching/AppliedMachineLearning2026.html)
